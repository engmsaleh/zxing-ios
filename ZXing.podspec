Pod::Spec.new do |s|
  s.name                        = "ZXing"
  s.version                     = "2.1.0"
  s.summary                     = "Multi-format 1D/2D barcode image processing library. Additions for iPad popover support and removal of unused files for iOs development"
  ...
  s.source                      = { :git => "https://github.com/krummler/zxing-ios.git", :tag => "2.1.0" }
